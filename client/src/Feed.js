...
import { JsonRpcProvider, WebSocketProvider, getDefaultProvider } from 'ethers';
import Twitter from './utils/TwitterClone.json'
  ...
  const getAllTweets = async() => {
    try {
      ...
      if(ethereum) {
        ...
        // const provider = new JsonRpcProvider(ethereum);
